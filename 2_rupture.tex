...
\begin{table}[h]
	...
	\begin{tabular}{rl}
		...
		\hline
		syndrome Charcot-Féré & migraine ophtalmique \\ 
		paralysie agitante & maladie (syndrome) de Parkinson\\
		...
		tremblement &  tremblement intentionnel (mouvement ciblé)\\
		nystagmus & mouvements rythmiques et involontaires des yeux  \\
		embarras parole & troubles de la parole\\
		sclérose latérale amyotrophique & maladie de Charcot / Lou Gehrig\\
		aphasie & \\
		idée(s) fixe(s), maladie des tics convulsifs & syndrome (maladie) de Tourette\\
		...
		hypnose & transe \\
		\hline		\multicolumn{2}{c}{\textbf{\textsc{Termes généraux associés à Charcot}}} \\
		systématisation de l'organisation de la moëlle épinière & \\
		localisations cérébrales & \\
		méthode anatomo-clinique & dimension histologique de l'anatomie macroscopique\\
		\hline\hline
	\end{tabular}
}
...
%	\centering
%	\begin{tabular}{rl}
	%		\multicolumn{2}{c}{\textbf{\textsc{Pathologie}}} \\
	%		\textbf{Nom traditionnel} & \textbf{Nom moderne / alternatif} \\
	%		\hline
	%		athétose & mouvements involontaires\\
	%		épilepsie & attaques convulsives \\
	...
	%		\hline
	%	\end{tabular}
%	\caption{Termes médicaux transmis par Charcot. À gauche : noms traditionnels ; à droite : noms modernes ou alternatifs.}
%	\label{tab:contributions_transmission_charcot}
%\end{table}
