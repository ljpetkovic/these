...
\begin{tcolorbox}[colback=yellow!10!white,colframe=red!75!black,title=agenda]
	\begin{itemize}
		\item Le moteur de recherche \textsc{OBVIE} permet également de repérer des textes similaires par ordre de pertinence à partir des termes simples en commun (mots fréquents, noms cités)... là encore, approche non suffisante
	\end{itemize}
\end{tcolorbox}
