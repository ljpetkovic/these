...
Nous dressons la liste des termes médicaux étroitement associés à Charcot, avec à gauche les appellations pathologiques traditionnelles, et à droite leurs équivalents modernes ou alternatifs (tableau \ref{tab:contributions_charcot}). Nous y mettons en évidence les termes dont Charcot est considéré comme l'initiateur, d'après deux sources majeures : \citet{walusinski} et \citet{camargo2024}. En revanche, certains termes comme \textit{hystérie}, \textit{hypnose}, \textit{épilepsie} ou \textit{athétose} s'inscrivent davantage dans une logique de transmission que d'une invention \textit{stricto sensu}. 
