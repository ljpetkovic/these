...
Nous dressons les listes des termes médicaux étroitement associés à Charcot, avec à gauche les appellations pathologiques traditionnelles, et à droite leurs équivalents modernes ou alternatifs. Nous y mettons en évidence les termes dont Charcot est considéré comme l'initiateur (tableau \ref{tab:contributions_charcot}), d'après deux sources majeures : \citet{walusinski} et \citet{camargo2024}. En revanche, certains termes comme \textit{hystérie}, \textit{hypnose}, \textit{épilepsie} ou \textit{athétose} s'inscrivent davantage dans une logique de transmission que d'une invention \textit{stricto sensu} (tableau \ref{tab:contributions_transmission_charcot}). 
...
\begin{table}[h]
	...
	\begin{tabular}{rl}
		...
		\hline
	\end{tabular}
	\caption{Termes médicaux inventés par Charcot. À gauche : noms traditionnels ; à droite : noms modernes ou alternatifs.}
