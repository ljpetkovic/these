...
\begin{table}[!ht]
    ...
    \rowcolor{yellow!30}
    \small
       \textit{Corpus} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}\small \textit{Nombre} \vspace{-0.20cm} \\ \small \textit{de documents}\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}\small \textit{Nombre de tokens}\end{tabular}} \\ \hline
