...
Cette thématique est au c\oe{}ur des préoccupations des structures de recherche universitaires (laboratoires, chaires), des évènements scientifiques ou même des numéros de revues spécialisés, recensés dans les tableaux \ref{tab:equipes}, \ref{tab:events} et \ref{tab:revues}.
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}[t]{|p{7cm}|p{7cm}|}
			\hline
			\textbf{Équipe} & \textbf{Études numériques des circulations} \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}[t]{|p{3.5cm}|p{5cm}|p{6cm}|}
		...
		Colloque & Humanistica 2023\footnote{\url{https://humanistica2023.sciencesconf.org/}} & bbb \\ \hline
		Colloque & \og{}De la transformation des sciences humaines par les humanités numériques\fg{} (ACFAS 2023)\footnote{\url{https://www.crihn.org/nouvelles/2022/12/11/colloque-de-la-transformation-des-sciences-humaines-par-les-humanites-numeriques-acfas-2023/}} & bbb \\ \hline
		Journée d'étude &
		\begin{minipage}[t]{\linewidth}
