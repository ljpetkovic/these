...
\input{3_methodo}
%\chapter{Jean-Martin Charcot : un médecin à l'aube de la neurologie moderne}
%\label{rupture}
%\input{2_rupture}
...
%\part{Pister la circulation des savoirs médicaux au prisme du numérique}
\input{4_resultats}
%\chapter{Valorisation du fonds Charcot}
%\chapter{Pister la circulation du discours médical de Charcot au prisme du numérique}
