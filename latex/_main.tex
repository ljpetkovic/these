...
\babelfont[russian]{rm}[
  ...
  Script=Cyrillic
]{Times New Roman} % Ensure proper font for Cyrillic
\usepackage[OT2,LGR,T1]{fontenc}
...
\newcommand{\smalltodo}[2][]{\todo[size=\scriptsize, color=RoyalBlue2, textcolor=white #1]{#2}}
...
\todo[size=\footnotesize]{This is a smaller margin note.}
