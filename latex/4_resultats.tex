...
%	\multicolumn{1}{|c|}{C \& A} & \multicolumn{1}{|c|}{\textsc{N}}	& \multicolumn{1}{|c|}{\texttt{nom}} & \multicolumn{1}{|c|}{\textit{hystérie}} \\
%	\multicolumn{1}{|c|}{C \& A} & \multicolumn{1}{|c|}{\textsc{N A}}	& \multicolumn{1}{|c|}{\texttt{nom + adjectif}} & \multicolumn{1}{|c|}{\textit{lame médullaire}} \\
%	\multicolumn{1}{|c|}{C} & \multicolumn{1}{|c|}{\textsc{N A A}}	& \multicolumn{1}{|c|}{\texttt{nom + adjectif + adjectif}} & \multicolumn{1}{|c|}{\textit{système nerveux central}} \\
%	\multicolumn{1}{|c|}{C \& A} & \multicolumn{1}{|c|}{\textsc{N P N}}	& \multicolumn{1}{|c|}{\texttt{nom + préposition + nom}} & \multicolumn{1}{|c|}{\textit{trouble de sensibilité}} \\
%	\multicolumn{1}{|c|}{C \& A} & \multicolumn{1}{|c|}{\textsc{R}}	& \multicolumn{1}{|c|}{\texttt{adverbe}} & \multicolumn{1}{|c|}{\textit{[d']emblée}} \\
%	\hline\hline
	\end{tabular}
...
%\begin{itemize}
%	\item \textsc{A} : \texttt{adjectif} (\textit{cérébral})
%	\item \textsc{N} : \texttt{nom} (\textit{hystérie})
%	\item \textsc{N A} : \texttt{nom + adjectif} (\textit{lame médullaire})
%	\item \textsc{N A A} : \texttt{nom + adjectif + adjectif} (\textit{système nerveux central})
%	\item \textsc{N P N} : \texttt{nom + préposition + nom} (\textit{trouble de sensibilité})
%	\item \textsc{R} : \texttt{adverbe} : \textit{[d']emblée}
%\end{itemize} 
