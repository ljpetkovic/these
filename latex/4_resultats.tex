...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|lrrr|rrl|}
			\hline\hline
			\rowcolor{grey!10}\multicolumn{4}{|c|}{Corpus Charcot}                                                                    & \multicolumn{3}{|c|}{Corpus Autres}                               \\ \hline
...
\begin{itemize}
	\item DF : fréquence documentaire
	\item spécificité
	\item TF-IDF
	\item fréquence absolue de chaque terme extrait
\end{itemize}
