...
Liste de X concepts associés à Charcot dans le domaine de neurosciences (neurologie, neuropathologie et psychiatrie, donc en excluant les autres domaines comme endocrinologie, néphrologie etc.) + méthodes d'extraction des phrases-clés :
\begin{itemize}
