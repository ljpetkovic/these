...
Pour ce qui est des projets individuels, la question de l'estimation de l'importance d'une entité issue d'un domaine occupe une place centrale dans le travail de \citet{soulet2024}, ayant comme conséquence le développement de l'outil Rankingdom\footnote{\url{https://rankingdom.org/about}.}.

\hl{desc brève des points principaux de cet outil}
