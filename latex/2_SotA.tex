...
(\citealp{landais2014frederic,quet2014frederic}). Le terme en question reste toutefois assez complexe en raison de visions différentes sur la façon de le définir. Afin d'éclairer cette problématique, \citet{quet2014frederic} \smalltodo{3 aspects} souligne trois aspects suivants :
\begin{enumerate}
...
%dont linguistique (générale, cognitive, psycholinguistique, ethnolinguistique), philosophie, métaphysique ou mathématiques
 \citep{nemickiene2011concept}.\smalltodo{concept linguistique} \hl{à développer}
