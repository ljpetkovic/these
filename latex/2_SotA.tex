...
\begin{itemize}
\item TermoStat \citep{drouin2003} : termes simples vs. complexes nominaux ; à base de règles ; limite de corpus : 30 Mo, extraction des POS
\item extraction terminologique \texttt{TermSuite} \citep{cram2016terminology} : scalable
